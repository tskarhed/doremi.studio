...
export const LoginView = () => {
  ...
  <Page title="Login" editable={false}>
    <div style={{ display: "flex", height: "100%", flexDirection: "column", justifyContent: "center", padding: "5%"}}>
      <p>Log in or continue anonymously</p>
      <Login afterLogin={handleLogin}/>
      {showMissingFields && <ProfileForm initialValues={{displayName}} onSubmit={registerNewUser}/>}
    </div>
    </Page>);
}